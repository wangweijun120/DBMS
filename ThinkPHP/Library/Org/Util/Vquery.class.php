...
// header("content-type:text/html;charset=utf-8");
     ...
     * [description]
     *
     * Feedback To MyE-mail:ley@nbinbi.com  Or maxyang@nbinbi.com
     *
     *
     *Look forward to your guidance criticism!
     *
     */
// namespace Org\Util;(如果是tp框架，请去掉本行注释)
class Vquery
{
    public $htmlContent;
    public $result = array();
    ...
    function curl_request($url, $method, $header, $data, $timeout = 0)
    {
        ...
        if ($method == "get") {
            ...
            curl_setopt($conn, CURLOPT_SSL_VERIFYPEER, FALSE); // https请求 不验证证书和hosts
