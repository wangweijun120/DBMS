    ...
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <form class="navbar-form navbar-right">
                <input type="text" class="form-control" placeholder="wait for using...">
            </form>
        </div>
    </div>
</nav>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">植物</h1>

            <div class="row placeholders">
                <div class="col-xs-6 col-sm-3 placeholder">
                    <img src="/spider/Public/image/data0.png" width="200" height="200" class="img-responsive"
                         alt="Generic placeholder thumbnail">
                    <h4>data0</h4>
                    <span class="text-muted">待定...</span>
                </div>
                <div class="col-xs-6 col-sm-3 placeholder">
                    <img src="/spider/Public/image/data1.png" width="200" height="200" class="img-responsive"
                         alt="Generic placeholder thumbnail">
                    <h4>data1</h4>
                    <span class="text-muted">待定...</span>
                </div>
                <div class="col-xs-6 col-sm-3 placeholder">
                    <img src="/spider/Public/image/data2.png" width="200" height="200" class="img-responsive"
                         alt="Generic placeholder thumbnail">
                    <h4>data2</h4>
                    <span class="text-muted">待定...</span>
                </div>
                <div class="col-xs-6 col-sm-3 placeholder">
                    <img src="/spider/Public/image/data4.png" width="200" height="200" class="img-responsive"
                         alt="Generic placeholder thumbnail">
                    <h4>data4</h4>
                    <span class="text-muted">待定...</span>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($vo["Scientific_Name"]); ?></td>
